...
<div class="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Welcome<?php echo " ".$redis-> hget ("Test_user_id ".$x, username); ?></a>
                </div>
 ...
 <form action="taketest.php" method="_GET">
  <input type="hidden" name="answer" value="hii">
</form>
                            ...
                            //$_SESSION[answer]="hii";
                                  echo " <tbody>
                                        <tr>
                                            ...
                                            <td>".$id."</td>
                                            <td>20</td>
                                            <td ><a href='taketest.php?sub=".$sub."&id=".$id."'><button style='text-decoration: none;color: black;'>Answers</button></a></td>
